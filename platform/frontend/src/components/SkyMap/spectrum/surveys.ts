...
export const SURVEYS = [
  ...
  },
  {
    ...
    label: 'Visible Light',
    shortLabel: 'Visible',
    title: 'Mellinger all-sky optical color survey',
    description: 'Full-sky natural-color optical mosaic — the Milky Way, star colors, and nearby galaxies in true visible light.',
